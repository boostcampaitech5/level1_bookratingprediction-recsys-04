...
def main(args):
    ...
    if args.model in ('FM', 'FFM', 'XGBoost'):
    ...
    if args.model in ('FM', 'FFM','XGBoost', 'NCF', 'WDN', 'DCN', 'CNN_FM', 'DeepCoNN'):
...
if __name__ == "__main__":
    ...
    arg('--model', type=str, choices=['FM', 'FFM', 'NCF', 'WDN', 'DCN', 'CNN_FM', 'DeepCoNN', 'XGBoost'],
